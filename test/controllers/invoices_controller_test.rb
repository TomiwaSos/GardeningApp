class InvoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create a new invoice" do
    assert_difference('Invoice_count', 1) do
      post invoices_url, params: {amount_due: '100', due_date: '01/03/2024', payment_status: '0', client_id: '1'}
    end
    assert_response :success
  end
  ...
  test "should not creat an invoice with an empty Amount_Due parameter" do
    assert_no_difference('Invoice_count') do
  ...
  test "should update invoice" do
    patch invoice_url(@invoice), params: {amount_due: '200', due_date: '04/04/2024', payment_status: '1', client_id: '2'}
    @invoice.reload
